...
const mockProductData = {
  ...
  description:
    "A super comfortable, lightweight t-shirt perfect for everyday wear.",
  price: 29.99,
  ...
  reviews: [
    {
      ...
      stars: 5,
      comment:
        "These headphones are amazing! The noise cancellation is perfect for my daily commute.",
      date: "2023-05-15",
    ...
    },
    {
      ...
      stars: 4,
      comment:
        "Great sound quality and comfortable fit. Battery life is good but not as long as advertised.",
      date: "2023-04-22",
    ...
    .filter(
      (p) =>
        ...
        (p.categories?.some((cat) =>
          ...
          true)
    ) // For demo, include all products but would filter by shared category
    .slice(0, 4);
          ...
          <div className="space-y-6">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                {product.onSale && (
                  <Badge variant="destructive" className="ml-2">
                    {Math.round(Number(product.activeDiscount?.percentage))}%
                    OFF
                  </Badge>
                )}
              </div>
            ...
            {product.sizes.length > 0 && (
              <div className="space-y-2">
                <label className="text-sm font-medium">
                  Size:{" "}
                  {product.sizes.find((s) => s.sizeId === selectedSize)?.size ||
                    "Select a size"}
                </label>
                <div className="flex flex-wrap gap-2">
        ...
        <Tabs defaultValue="description" className="w-full">
          ...
          <TabsContent value="description" className="text-muted-foreground">
            ...
            <p className="mt-4">
              ...
              augue at nunc cursus fermentum. Integer facilisis, velit vitae
              vestibulum eleifend, sem velit vehicula tortor, nec ultrices erat
              felis nec quam. Donec eget turpis semper, commodo ante sed,
              faucibus mi. Phasellus sodales pellentesque ex, at iaculis ligula.
              Fusce sodales mi id tincidunt posuere.
            </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p>
                  ...
                  orders under $50, shipping costs are calculated at checkout
                ...
                <ul className="list-disc list-inside mt-4 space-y-1">
                  ...
                  <li>
                    International Shipping: 7-14 business days (varies by
                    location)
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p>
                  ...
                  or exchange. Items must be in original, unused condition with
                  all original packaging and tags attached.
                </p>
                <p className="mt-2">
                  Please note that the customer is responsible for return
                  shipping costs unless the return is due to a defect or error
                  on our part.
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  claims, please contact our customer service team.
                </p>
              </div>
            </div>
          </TabsContent>
