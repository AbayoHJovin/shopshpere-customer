...
import { Star, Check, ShoppingCart, Heart, Share2, Clock, Truck, Shield, ChevronLeft, ChevronRight } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import ProductCard from "@/components/ProductCard";
import { allProducts } from "@/data/products";
import { getRandomImage } from "@/lib/utils";

// Example mock data to match backend DTOs
const mockProductData = {
  productId: "123e4567-e89b-12d3-a456-426614174000",
  name: "Premium Wireless Headphones with Noise Cancellation",
  description: "Experience crystal-clear audio with our premium wireless headphones. Featuring advanced noise cancellation technology, these comfortable over-ear headphones provide up to 30 hours of battery life and connect seamlessly with all your devices.",
  price: 199.99,
  ...
  images: [
    ...
    { imageId: "img2", imageUrl: "https://images.unsplash.com/photo-1484704849700-f032a568e944", isMain: false, position: 1 },
    { imageId: "img3", imageUrl: "https://images.unsplash.com/photo-1583394838336-acd977736f90", isMain: false, position: 2 },
    { imageId: "img4", imageUrl: "https://images.unsplash.com/photo-1487215078519-e21cc028cb29", isMain: false, position: 3 }
  ],
  categories: [
    { categoryId: "cat1", name: "Electronics", description: "Electronic devices", parentId: null, parentName: null, hasSubcategories: true, subcategoryCount: 5, productCount: 120 },
    { categoryId: "cat2", name: "Audio", description: "Audio equipment", parentId: "cat1", parentName: "Electronics", hasSubcategories: true, subcategoryCount: 3, productCount: 45 },
    { categoryId: "cat3", name: "Headphones", description: "Headphone equipment", parentId: "cat2", parentName: "Audio", hasSubcategories: false, subcategoryCount: 0, productCount: 20 }
  ],
  ...
  topRatings: [
    ...
    },
    {
      ...
      createdAt: "2023-05-22T09:45:00",
      verifiedPurchase: true
    },
    {
      ratingId: "rating3",
      stars: 5,
      comment: "Perfect fit and amazing sound isolation. Worth every penny!",
      productId: "123e4567-e89b-12d3-a456-426614174000",
      productName: "Premium Wireless Headphones with Noise Cancellation",
      userId: "user3",
      username: "MusicLover",
      userProfilePicture: "https://i.pravatar.cc/150?u=3",
      createdAt: "2023-04-10T16:20:00",
...
export default function ProductPage() {
  ...
  const handleCartToggle = () => {
    try {
      ...
      if (isInCart) {
        // Remove from cart
        const newCart = cart.filter((cartId: string) => cartId !== id);
  ...
  const handleWishlistToggle = () => {
    ...
    // We would add actual localStorage logic here if implementing wishlist
  };
  
  // Generate similar products
  const similarProducts = allProducts
    .filter(p => p.id !== id && (p.categories?.some(cat => 
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className={isInWishlist ? 'bg-muted' : ''}
          ...
          <div className="lg:col-span-2">
            {product.topRatings && product.topRatings.length > 0 ? (
              <div className="space-y-6">
                ...
                {product.ratingCount > product.topRatings.length && (
